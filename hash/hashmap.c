 ...
 */
hashmap_map* hashmap_put(hashmap_map* m, char* key, any_t value){
	int index;
 ...
 */
int hashmap_get(hashmap_map *m, char* key, any_t *arg){
	int curr;
	int i;
	/*
	hashmap_map* m;
 ...
 */
int hashmap_iterate(hashmap_map *m, PFany f, any_t item) {
	int i;
